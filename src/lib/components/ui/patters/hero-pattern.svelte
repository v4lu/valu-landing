...
<div class="relative mt-[60px] min-h-[calc(100dvh-60px)] w-full flex-1 overflow-x-hidden">
	...
	>
		<div
			class="aspect-[1108/632] w-[69.25rem] bg-gradient-to-r from-[#ff9797] to-[#e54646] opacity-10"
